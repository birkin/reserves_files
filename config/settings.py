"""
Django settings for reserves_files_project project.
...
DATABASES = json.loads( os.environ['RES_FILES__DATABASES_JSON'] )
...
STATIC_URL = os.environ['RES_FILES__STATIC_URL']
STATIC_ROOT = os.environ['RES_FILES__STATIC_ROOT']
...
LOGGING = {
    ...
    'handlers': {
        ...
        'logfile': {
            ...
            'filename': os.environ['RES_FILES__LOG_PATH'],
            'formatter': 'standard',
        },
        'console':{
            'level':'DEBUG',
